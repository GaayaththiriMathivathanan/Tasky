...
public final class ActivityProfileBinding implements ViewBinding {
  ...
  private ActivityProfileBinding(@NonNull LinearLayout rootView, @NonNull Button btnBack,
      @NonNull Button btnSaveChanges, @NonNull EditText etDob, @NonNull EditText etEmail,
      @NonNull EditText etName, @NonNull EditText etPassword, @NonNull EditText etPhone,
      @NonNull ImageView imgAvatar, @NonNull Toolbar toolbar) {
  ...
  public static ActivityProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityProfileBinding((LinearLayout) rootView, btnBack, btnSaveChanges, etDob,
          etEmail, etName, etPassword, etPhone, imgAvatar, toolbar);
    }

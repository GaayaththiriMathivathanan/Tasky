...
public final class ActivityTaskBinding implements ViewBinding {
  ...
  private ActivityTaskBinding(@NonNull LinearLayout rootView, @NonNull Button btnAddTask,
      @NonNull Button btnProfile, @NonNull EditText etDate, @NonNull EditText etTask,
  ...
  public static ActivityTaskBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTaskBinding((LinearLayout) rootView, btnAddTask, btnProfile, etDate,
          etTask, recyclerView, toolbar);
    }

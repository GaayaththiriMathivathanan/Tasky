...
public final class NavHeaderBinding implements ViewBinding {
  ...
  private NavHeaderBinding(@NonNull LinearLayout rootView, @NonNull TextView tvUserName,
      @NonNull TextView tvUserProfession) {
  ...
  public static NavHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView tvUserProfession = ViewBindings.findChildViewById(rootView, id);
      if (tvUserProfession == null) {
        break missingId;
      }

      return new NavHeaderBinding((LinearLayout) rootView, tvUserName, tvUserProfession);
    }

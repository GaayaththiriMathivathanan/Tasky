...
public final class ActivityOnboarding3Binding implements ViewBinding {
  ...
  private ActivityOnboarding3Binding(@NonNull LinearLayout rootView,
      @NonNull Button btnGetStarted) {
  ...
  public static ActivityOnboarding3Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOnboarding3Binding((LinearLayout) rootView, btnGetStarted);
    }
